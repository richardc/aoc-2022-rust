...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `61.6µs` | `68.1µs` |
| [Day 2](./src/bin/02.rs) | `88.7µs` | `87.8µs` |
| [Day 3](./src/bin/03.rs) | `282.9µs` | `301.7µs` |
| [Day 4](./src/bin/04.rs) | `76.7µs` | `77.6µs` |
| [Day 5](./src/bin/05.rs) | `120.7µs` | `131.0µs` |
| [Day 6](./src/bin/06.rs) | `167.9µs` | `1.2ms` |
| [Day 7](./src/bin/07.rs) | `389.9µs` | `408.9µs` |
| [Day 8](./src/bin/08.rs) | `249.7µs` | `388.4µs` |
| [Day 9](./src/bin/09.rs) | `635.4µs` | `900.0µs` |
| [Day 10](./src/bin/10.rs) | `8.6µs` | `9.3µs` |
| [Day 11](./src/bin/11.rs) | `47.5µs` | `21.5ms` |
| [Day 12](./src/bin/12.rs) | `926.5µs` | `46.8ms` |
| [Day 13](./src/bin/13.rs) | `654.4µs` | `777.0µs` |
| [Day 14](./src/bin/14.rs) | `4.0ms` | `220.2ms` |
